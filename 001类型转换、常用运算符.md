...
![](D:\Photos\Snipaste_2022-02-27_15-04-38.png)
...
![](D:\Photos\Snipaste_2022-02-27_15-41-14.png)
...
2、String.valueOf()，推荐使用，因为当对象为null时，返回字符串“null”
	String.valueOf()方法是推荐使用的，因为它不会出现空指针异常，而且是静态的方法，直接通过String调用即可，只是有一点需要注意，就是上面提到的，如果为	 	 对象为null，String.valueOf()返回结果是字符串“null”。而不是null。
...
![](D:\Photos\Snipaste_2022-02-28_21-50-48.png)
...
![](D:\Photos\Snipaste_2022-03-01_08-03-58.png)

![](D:\Photos\Snipaste_2022-03-01_08-05-26.png)
...
![](D:\Photos\Snipaste_2022-03-02_15-01-07.png)
